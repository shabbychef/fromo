...
//' \describe{
//' \item{t_running_covariance}{Returns a single column of the covariance of \code{x} and \code{y}.}
//' \item{t_running_correlation}{Returns a single column of the correlation of \code{x} and \code{y}.}
//' \item{t_running_covariance_3}{Returns three columns: the variance of \code{x}, the covariance of \code{x} and \code{y}, and the
//' variance of \code{y}, in that order.}
//' \item{t_running_regression_slope}{Returns a single column of the slope of the OLS regression.}
//' \item{t_running_regression_intercept}{Returns a single column of the intercept of the OLS regression.}
//' \item{t_running_regression_fit}{Returns two columns: the regression intercept and the regression slope of the OLS regression.}
//' \item{t_running_regression_diagnostics}{Returns five columns: the regression intercept, the regression slope, the regression standard error, 
