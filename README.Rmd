...
do.call("all.equal",args=lapply(vals,function(x) { x[wins+1] }))
do.call("all.equal",args=lapply(vals,function(x) { x[length(x)] }))
do.call("all.equal",args=lapply(vals,function(x) { x[length(x)-1] }))
do.call("all.equal",args=lapply(vals,function(x) { x[length(x)-100] }))
